...
const Recommended = () => {
  ...
  return (
    <><section className="bg-gray-100 md:block hiddenshadow-md">
      <div className="container mx-auto px-4 py-4">
        <h1 className="text-2xl font-bold pb-1">Recommended Items</h1>
        {/* Grid of Recommended Items */}
        <div className="md:grid hidden grid-cols-1 md:grid-cols-5 gap-3 py-3">
    ...
    </section><div className="grid md:hidden md:first-letter:hidden grid-cols-2 gap-3 py-3">
